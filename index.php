...
<head>
  ...
  <title>E-Vaccination Management System</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">E-Vaccination Management System</a>
  ...
  <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="new-user-testing.php">Vaccination</a>
          </li>
           <li class="nav-item active">
  ...
  <header class="bg-primary text-white">
    <div class="container text-center">
      <h1>E-Vaccination</h1>
      <p class="lead">E-Vaccination Management System</p>
    </div>
  </header>
