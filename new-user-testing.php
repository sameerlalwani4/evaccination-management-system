...
<head>
    ...
    <title>Covid-19 Vaccination Management System | New User Vaccination</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Covid19-Vaccination</h1>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Antigen">Covaxin</option>  
                                            <option value="RT-PCR">Covishield</option>
                                            <option value="CB-NAAT">Sputnik</option>    
                                              </select>
                                        </div>
