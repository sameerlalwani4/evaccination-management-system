...
<head>
    ...
    <title>E-Vaccination Management System | Vaccine Details</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Vaccine Details# <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
$testid=intval($_GET['tid']);
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    ...
    <tr>
    <th>Certificate Delivered Time</th> 
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Vaccine  Tracking History</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<!--            <option value="Sample Collected">Sample Collected</option>-->
       ...
       <p id='reportfile'> Certificate <span style="color:red; font-size:12px;">(Doc and PDF formate allowed)</span>    <input type="file" name="report" id="report"></p>
       <p>
